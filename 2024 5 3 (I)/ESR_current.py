...
currents = np.arange(000,372) / 100
freq, loss_0 = loss_list(3.53)
...
range = np.linspace(-0.03,0.03,20)
print(resonance_fre + range)
for frequency in tqdm(resonance_fre + range):
