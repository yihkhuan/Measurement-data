    ...
    for i in range(len(data_blocks)):
        ...
        for line in chosen_block:
            ...
            try:
                ...
                z_data = np.append(z_data, float(values[2]))
        ...
        z = np.reshape(z,(len(data_blocks),-1))
...
def UTM_2D_plot(ax, x:np.ndarray, y:np.ndarray, title:str, xlabel:str, ylabel:str, label= None):
